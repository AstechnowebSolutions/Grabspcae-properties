                            ...
                            <div class="service-sidebar">
                                <div class="widget category">
                                    ...
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-angle-double-right"></i>Coworking</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Private Offices</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Dedicated Desk</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Green Room</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Meeting Place</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Library</a>
                                        <a href="#"><i class="far fa-angle-double-right"></i>Conference Rooms</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                <div class="service-details-img mb-30">
                                    <img src="{{asset('frontend/assets/img/service/single.jpg')}}" alt="thumb">
                                </div>
                                <div class="service-details">
                                    <h3 class="mb-30">Dedicated Office</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-20">
                                            <img src="{{asset('frontend/assets/img/service/01.jpg')}}" alt="">
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <img src="{{asset('frontend/assets/img/service/02.jpg')}}" alt="">
                                        </div>
                                    </div>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Why Choose Our Services ?</h3>
